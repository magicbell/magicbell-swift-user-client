...
public struct Client: APIProtocol {
    ...
    public func list_magicbell_slackbot_tokens(_ input: Operations.list_magicbell_slackbot_tokens.Input) async throws -> Operations.list_magicbell_slackbot_tokens.Output {
        try await client.send(
            input: input,
            forOperation: Operations.list_magicbell_slackbot_tokens.id,
            serializer: { input in
                let path = try converter.renderedPath(
                    template: "/channels/slack/magicbell_slackbot/tokens",
                    parameters: []
                )
                var request: HTTPTypes.HTTPRequest = .init(
                    soar_path: path,
            ...
            deserializer: { response, responseBody in
                ...
                case 200:
                    let contentType = converter.extractContentTypeIfPresent(in: response.headerFields)
                    let body: Operations.list_magicbell_slackbot_tokens.Output.Ok.Body
                    let chosenContentType = try converter.bestContentType(
                        received: contentType,
                        options: [
                            "application/json"
    ...
    public func save_magicbell_slackbot_token(_ input: Operations.save_magicbell_slackbot_token.Input) async throws -> Operations.save_magicbell_slackbot_token.Output {
        try await client.send(
            input: input,
            forOperation: Operations.save_magicbell_slackbot_token.id,
            serializer: { input in
                let path = try converter.renderedPath(
                    template: "/channels/slack/magicbell_slackbot/tokens",
                    parameters: []
            ...
            deserializer: { response, responseBody in
                ...
                case 200:
                    let contentType = converter.extractContentTypeIfPresent(in: response.headerFields)
                    let body: Operations.save_magicbell_slackbot_token.Output.Ok.Body
                    let chosenContentType = try converter.bestContentType(
                        received: contentType,
                        options: [
                            "application/json"
    ...
    public func fetch_magicbell_slackbot_token(_ input: Operations.fetch_magicbell_slackbot_token.Input) async throws -> Operations.fetch_magicbell_slackbot_token.Output {
        try await client.send(
            input: input,
            forOperation: Operations.fetch_magicbell_slackbot_token.id,
            serializer: { input in
                let path = try converter.renderedPath(
                    template: "/channels/slack/magicbell_slackbot/tokens/{}",
                    parameters: [
            ...
            deserializer: { response, responseBody in
                ...
                case 200:
                    let contentType = converter.extractContentTypeIfPresent(in: response.headerFields)
                    let body: Operations.fetch_magicbell_slackbot_token.Output.Ok.Body
                    let chosenContentType = try converter.bestContentType(
                        received: contentType,
                        options: [
                            "application/json"
    ...
    public func delete_magicbell_slackbot_token(_ input: Operations.delete_magicbell_slackbot_token.Input) async throws -> Operations.delete_magicbell_slackbot_token.Output {
        try await client.send(
            input: input,
            forOperation: Operations.delete_magicbell_slackbot_token.id,
            serializer: { input in
                let path = try converter.renderedPath(
                    template: "/channels/slack/magicbell_slackbot/tokens/{}",
                    parameters: [
            ...
            deserializer: { response, responseBody in
                ...
                case 200:
                    let contentType = converter.extractContentTypeIfPresent(in: response.headerFields)
                    let body: Operations.delete_magicbell_slackbot_token.Output.Ok.Body
                    let chosenContentType = try converter.bestContentType(
                        received: contentType,
                        options: [
                            "application/json"
    ...
    public func fetch_user_preferences(_ input: Operations.fetch_user_preferences.Input) async throws -> Operations.fetch_user_preferences.Output {
        try await client.send(
            input: input,
            forOperation: Operations.fetch_user_preferences.id,
            serializer: { input in
                let path = try converter.renderedPath(
                    template: "/channels/user_preferences",
                    parameters: []
                )
                var request: HTTPTypes.HTTPRequest = .init(
                    soar_path: path,
            ...
            deserializer: { response, responseBody in
                ...
                case 200:
                    let contentType = converter.extractContentTypeIfPresent(in: response.headerFields)
                    let body: Operations.fetch_user_preferences.Output.Ok.Body
                    let chosenContentType = try converter.bestContentType(
                        received: contentType,
                        options: [
                            "application/json"
                    ...
                    case "application/json":
                        body = try await converter.getResponseBodyAsJSON(
                            Components.Schemas.UserPreferences.self,
                            from: responseBody,
                            transforming: { value in
                                .json(value)
                            }
    ...
    public func save_user_preferences(_ input: Operations.save_user_preferences.Input) async throws -> Operations.save_user_preferences.Output {
        try await client.send(
            input: input,
            forOperation: Operations.save_user_preferences.id,
            serializer: { input in
                let path = try converter.renderedPath(
                    template: "/channels/user_preferences",
                    parameters: []
    ...
    public func save_magicbell_slackbot_installation(_ input: Operations.save_magicbell_slackbot_installation.Input) async throws -> Operations.save_magicbell_slackbot_installation.Output {
        try await client.send(
            input: input,
            forOperation: Operations.save_magicbell_slackbot_installation.id,
            serializer: { input in
                let path = try converter.renderedPath(
                    template: "/integrations/magicbell_slackbot/installations",
                    parameters: []
                )
                var request: HTTPTypes.HTTPRequest = .init(
                    soar_path: path,
            ...
            deserializer: { response, responseBody in
                ...
                case 200:
                    let contentType = converter.extractContentTypeIfPresent(in: response.headerFields)
                    let body: Operations.save_magicbell_slackbot_installation.Output.Ok.Body
                    let chosenContentType = try converter.bestContentType(
                        received: contentType,
                        options: [
                            "application/json"
    ...
    public func finish_magicbell_slackbot_installation(_ input: Operations.finish_magicbell_slackbot_installation.Input) async throws -> Operations.finish_magicbell_slackbot_installation.Output {
        try await client.send(
            input: input,
            forOperation: Operations.finish_magicbell_slackbot_installation.id,
            serializer: { input in
                let path = try converter.renderedPath(
                    template: "/integrations/magicbell_slackbot/installations/finish",
                    parameters: []
                )
                var request: HTTPTypes.HTTPRequest = .init(
                    soar_path: path,
            ...
            deserializer: { response, responseBody in
                ...
                case 201:
                    let contentType = converter.extractContentTypeIfPresent(in: response.headerFields)
                    let body: Operations.finish_magicbell_slackbot_installation.Output.Created.Body
                    let chosenContentType = try converter.bestContentType(
                        received: contentType,
                        options: [
                            "application/json"
    ...
    public func start_magicbell_slackbot_installation(_ input: Operations.start_magicbell_slackbot_installation.Input) async throws -> Operations.start_magicbell_slackbot_installation.Output {
        try await client.send(
            input: input,
            forOperation: Operations.start_magicbell_slackbot_installation.id,
            serializer: { input in
                let path = try converter.renderedPath(
                    template: "/integrations/magicbell_slackbot/installations/start",
                    parameters: []
                )
                var request: HTTPTypes.HTTPRequest = .init(
                    soar_path: path,
            ...
            deserializer: { response, responseBody in
                ...
                case 201:
                    let contentType = converter.extractContentTypeIfPresent(in: response.headerFields)
                    let body: Operations.start_magicbell_slackbot_installation.Output.Created.Body
                    let chosenContentType = try converter.bestContentType(
                        received: contentType,
                        options: [
                            "application/json"
    ...
    public func mark_all_notifications_seen(_ input: Operations.mark_all_notifications_seen.Input) async throws -> Operations.mark_all_notifications_seen.Output {
        try await client.send(
            input: input,
            forOperation: Operations.mark_all_notifications_seen.id,
            serializer: { input in
                let path = try converter.renderedPath(
                    template: "/notifications/seen",
                    parameters: []
                )
                var request: HTTPTypes.HTTPRequest = .init(
                    soar_path: path,
    ...
    public func fetch_unread_notifications_count(_ input: Operations.fetch_unread_notifications_count.Input) async throws -> Operations.fetch_unread_notifications_count.Output {
        try await client.send(
            input: input,
            forOperation: Operations.fetch_unread_notifications_count.id,
            serializer: { input in
                let path = try converter.renderedPath(
                    template: "/notifications/unread/count",
                    parameters: []
                )
                var request: HTTPTypes.HTTPRequest = .init(
                    soar_path: path,
            ...
            deserializer: { response, responseBody in
                ...
                case 200:
                    let contentType = converter.extractContentTypeIfPresent(in: response.headerFields)
                    let body: Operations.fetch_unread_notifications_count.Output.Ok.Body
                    let chosenContentType = try converter.bestContentType(
                        received: contentType,
                        options: [
                            "application/json"
                    ...
                    case "application/json":
                        body = try await converter.getResponseBodyAsJSON(
                            Components.Schemas.CountResponse.self,
                            from: responseBody,
                            transforming: { value in
                                .json(value)
                            }
    ...
    public func mark_notification_seen(_ input: Operations.mark_notification_seen.Input) async throws -> Operations.mark_notification_seen.Output {
        try await client.send(
            input: input,
            forOperation: Operations.mark_notification_seen.id,
            serializer: { input in
                let path = try converter.renderedPath(
                    template: "/notifications/{}/seen",
                    parameters: [
